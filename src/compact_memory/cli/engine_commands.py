...
@engine_app.command(
    "init",
    help="Initializes a new Compact Memory engine store in a specified directory.\n\nUsage Example:\n  compact-memory engine init ./my_engine_dir --engine none --chunker SentenceWindowChunker",
)
def init_command(  # Renamed from init
    ...
    *,
    ...
    final_engine_id = engine_id_arg or ctx.obj.get("default_engine_id") or "none"
