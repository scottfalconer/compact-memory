...
"""Prototype-based long-term memory as a CompressionEngine."""
...
from CompressionEngine.contrib.prototype_system_utils import (
...
class PrototypeEngine(CompressionEngine):
...
register_compression_engine(
    PrototypeEngine.id, PrototypeEngine, source="contrib"
)

__all__ = ["PrototypeEngine"]
