...
from CompressionEngine.core.trace import CompressionTrace
...
from CompressionEngine.core import (
...
class ActiveMemoryEngine(CompressionEngine):
    """
    A compression engine that utilizes an ActiveMemoryManager instance
    to dynamically select and compress conversational context.
    """

    id = "active_memory_engine"
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._engine_kwargs = {k: v for k, v in kwargs.items()}
...
register_compression_engine(
    ActiveMemoryEngine.id, ActiveMemoryEngine, source="contrib"
)
